...
enum topLeft { player1, player2 }
enum topCenter { player1, player2 }
enum topRight { player1, player2 }
enum midLeft { player1, player2 }
enum midCenter { player1, player2 }
enum midRight { player1, player2 }
enum botLeft { player1, player2 }
enum botCenter { player1, player2 }
enum botRight { player1, player2 }
